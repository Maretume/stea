            ...
            <div class="card-body">
                <form method="POST" action="{{ route('users.update', $user) }}">
                    ...
                    <div class="mb-3">
                        ...
                        <small class="text-muted">Untuk mengubah role, gunakan fitur assign/remove role di halaman detail user.</small>
                    </div>
                    
                    <!-- Password Change Section -->
                    <div class="card bg-light mb-3">
                        <div class="card-header">
                            <h6 class="mb-0">Ubah Password (Opsional)</h6>
                        </div>
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-6 mb-3">
...
$(document).ready(function() {
    ...
    // Auto-update email when username is changed
